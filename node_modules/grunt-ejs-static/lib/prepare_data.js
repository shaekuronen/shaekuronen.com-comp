...
module.exports = exports = {
  ...
  prepare_data: function(key, data_object, path_to_layout, ejs_static) {
    ...
    if (typeof this_page_data.path_to_data !== 'undefined') {

      grunt.log.debug('prepare_data(): the path to data is ' + this_page_data.path_to_data);

      data_type_router(key, this_page_data, this_page_data.path_to_data);

    } else {
      grunt.log.debug('prepare_data(): the type of data is undefined');
    }
