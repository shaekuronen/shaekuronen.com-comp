...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('ejs_static', 'Render EJS templates as static HTML.', function() {
    ...
    function prepare_data(key, data_object, path_to_layout) {
        ...
        data_item.forEach(function(path_to_data) {
          ...
          // if path_to_data is an object
            ...
            Object.keys(path_to_data).forEach(function(the_key) {
              ...
              // get the filename to use as key when data added to data_object
              var the_filename = path.basename(the_key, '.json');
    ...
    function render_template(key, data_object, path_to_file, path_to_layout) {
      ...
      // prepare the data
      var prepped_data = prepare_data(key, data_object, path_to_layout); 
